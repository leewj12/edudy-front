...
//           <h1 className="text-2xl font-bold mb-6">운영 공지사항</h1>

//           {/* 등록 폼 */}
//           <form onSubmit={handleSubmit} className="flex items-center gap-2 mb-6">
//             <select name="type" value={form.type} onChange={handleChange} className="border p-1 text-sm">
...
//                 <th className="p-2 text-[12px] border-b border-gray-300 text-gray-500">제목</th>
//                 <th className="p-2 text-[12px] border-b border-gray-300 text-gray-500">공지일자</th>
//                 <th className="p-2 text-[12px] border-b border-gray-300 text-gray-500 w-[100px]">관리</th>
//               </tr>
//             </thead>
//             <tbody>
//               {notices.map(([type, title, date], idx) => (
//                 <tr key={idx} className="border-t hover:bg-gray-50 text-[13px]">
...
//                     )}
//                   </td>
//                   <td className="p-2 text-center text-gray-500">{date}</td>
//                   <td className="p-2 text-center text-sm">
//                     {editingIndex === idx ? (
//                       <>
//                         <button onClick={() => saveEdit(idx)} className="text-blue-600 hover:underline mr-2">저장</button>
//                         <button onClick={cancelEdit} className="text-gray-500 hover:underline">취소</button>
//                       </>
//                     ) : (
//                       <>
//                         <button onClick={() => startEdit(idx)} className="text-blue-600 hover:underline mr-2">수정</button>
//                         <button onClick={() => deleteNotice(idx)} className="text-red-500 hover:underline">삭제</button>
//                       </>
//                     )}
//                   </td>
//                 </tr>
